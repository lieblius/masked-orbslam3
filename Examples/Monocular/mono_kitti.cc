...
int main(int argc, char **argv)
{
    ...
    LoadImages(string(argv[4]), vstrMaskFilenames, vTimestamps2);
    // cout<< "argv[3] ="<< string(argv[3])<< endl;
    // exit();
    // LoadImages(string(argv[6]), vstrImageFilenames, vTimestamps);
    ...
    std::cout<< "mono_kitti start"<< std::endl;
    ...
    std::cout<< "mono_kitti end"<< std::endl;

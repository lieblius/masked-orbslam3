...
cv::Mat System::TrackMonocular(const cv::Mat &mask, const cv::Mat &im, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    std::cout<< "System TrackMonocular start"<< std::endl;
    cv::Mat Tcw = mpTracker->GrabImageMonocular(mask, im,timestamp,filename);
    std::cout<< "System TrackMonocular end"<< std::endl;
